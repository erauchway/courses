...
read_sf("https://raw.githubusercontent.com/aourednik/historical-basemaps/master/geojson/world_1914.geojson") |>
  st_transform(crs = target_crs) -> borders_14
ne_download(scale = 50, category = "physical", type = "land") |>
  st_transform(crs = target_crs) -> land
...
ggplot() +
  geom_sf(data = borders_14) +
  labs(
    title = "HIS119---EUROPE AT 1914",
    caption = "Map made using R, ggplot, and sf by Eric Rauchway with data from André Ourednik's Historical Basemaps."
  ) +
