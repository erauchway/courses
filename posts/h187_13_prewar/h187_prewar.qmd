...
read_csv("https://raw.githubusercontent.com/erauchway/mapbits/refs/heads/main/navy.csv") |>
  ...
  ggplot() +
  geom_col(aes(x = Year, y = n,fill = ship_ord, group = ship_ord), color = NA, position = position_dodge(width = 0.7)) +
...
::::{.v-center-container}
![](../media/America_first_committee_c_tribune_9_25_40.jpg){width="300" fig-align="center"}
![](../media/america_first_committee__dm_tribune__10_15_40.jpg)
::::
:::

:::{.content-hidden unless-format="pdf" .column-margin}
![](../media/America_first_committee_c_tribune_9_25_40.jpg)
...
Those ... who have studied the public addresses of the president, from his Chicago "quarantine speech" ... will understand his motivation and his objective. It is war.
...
Lewis courted by Nazis, who wanted to fund him.
